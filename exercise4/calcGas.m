...
%Mass transfer coef:
for i=1:RP
[Dim(i,:),k(i,:)]=masscoef(ptot,Ts(i),rhog(i),uz(i),VIS(i),YmassS(i,:),MM(i));
end
%%%%%%%%%%%%%%%%%%%%%%%%% generate the solver %%%%%%%%%%%%%%%%%%%%
...
dwCH4dz = 1./(rhog(2:n-1).*uz(2:n-1))...
 ...
 +Di/EPS.*(drhogdr(2:n-1).*dwCH4dr(2:n-1)...
      +rhog(2:n-1)./r(2:n-1).*dwCH4dr(2:n-1)...
      +rhog(2:n-1).*dwCH4dr2(2:n-1))...
      -k((2:n-1),1) .* rhog(2:n-1).* av./EPS.*(wCH4(2:n-1)-wCH4s(2:n-1)'));
%BCs:
...
dwCOdz = 1./(rhog(2:n-1).*uz(2:n-1))...
 ...
 +Di/EPS.*(drhogdr(2:n-1).*dwCOdr(2:n-1)...
      +rhog(2:n-1)./r(2:n-1).*dwCOdr(2:n-1)...
      +rhog(2:n-1).*dwCOdr2(2:n-1))...
      -k((2:n-1),2) .* rhog(2:n-1).* av./EPS.*(wCO(2:n-1)-wCOs(2:n-1)'));
resdwCOdr1 = dwCOdr(1);
resdwCOdr2 = dwCOdr(n);
...
dwCO2dz = 1./(rhog(2:n-1).*uz(2:n-1))...
 ...
 +Di/EPS.*(drhogdr(2:n-1).*dwCO2dr(2:n-1)...
      +rhog(2:n-1)./r(2:n-1).*dwCO2dr(2:n-1)...
      +rhog(2:n-1).*dwCO2dr2(2:n-1))...
      -k((2:n-1),3) .* rhog(2:n-1).* av./EPS.*(wCO2(2:n-1)-wCO2s(2:n-1)'));
...
dwH2dz = 1./(rhog(2:n-1).*uz(2:n-1))...
 ...
 +Di/EPS.*(drhogdr(2:n-1).*dwH2dr(2:n-1)...
      +rhog(2:n-1)./r(2:n-1).*dwH2dr(2:n-1)...
      +rhog(2:n-1).*dwH2dr2(2:n-1))...
      -k((2:n-1),4) .* rhog(2:n-1).* av./EPS.*(wH2(2:n-1)-wH2s(2:n-1)'));
resdwH2dr1 = dwH2dr(1);
resdwH2dr2 = dwH2dr(n);
...
dwH2Odz = 1./(rhog(2:n-1).*uz(2:n-1))...
 ...
 +Di/EPS.*(drhogdr(2:n-1).*dwH2Odr(2:n-1)...
      +rhog(2:n-1)./r(2:n-1).*dwH2Odr(2:n-1)...
      +rhog(2:n-1).*dwH2Odr2(2:n-1))...
      -k((2:n-1),5) .* rhog(2:n-1).* av./EPS.*(wH2O(2:n-1)-wH2Os(2:n-1)'));
